<template>
  ...
  <p>SEÇÃO 4 - POR QUANTO TEMPO OS DADOS PESSOAIS FICAM ARMAZENADOS?</p>
  <p>
    ...
    documento, conforme o disposto no inciso I do artigo 15 da Lei 13.709/18.
  </p>
  <p>
  ...
  <p>SEÇÃO 5 - SEGURANÇA DOS DADOS PESSOAIS ARMAZENADOS</p>
  <p>
  ...
  <p>SEÇÃO 6 - COMPARTILHAMENTO DOS DADOS</p>
  <p>
  ...
  <p>(Se os dados podem ser compartilhados)</p>

  <p>
    Os terceiros indicados recebem os dados na medida do necessário para permitir que eles realizem
  ...
  <p>
    Os fornecedores podem ser localizados ou possuir instalações localizadas em países diferentes.
    Nessas condições, os dados pessoais transferidos podem se sujeitar às leis de jurisdições nas
  ...
  <p>
    ...
    transferência e armazenamento desta informação em outros países.
  </p>
  <p>
    Ao ser redirecionado para um aplicativo ou site de terceiros, você não será mais regido por essa
  ...
  <p>SEÇÃO 10 – JURISDIÇÃO PARA RESOLUÇÃO DE CONFLITOS</p>
  <p>
